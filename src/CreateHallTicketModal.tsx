      ...
      >
        ...
        >
          ...
          <div className="flex items-center space-x-5 relative z-10">
            <div className="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center text-white shadow-xl border border-white/30">
          ...
          <button
            onClick={handleClose}
            className="w-11 h-11 rounded-xl bg-white/20 backdrop-blur-sm hover:bg-white/30 flex items-center justify-center text-white transition-all hover:scale-105 relative z-10 border border-white/30"
          >
        ...
        {/* Body with Sections */}
        <div className="flex-1 overflow-y-auto px-8 py-8 bg-gradient-to-br from-gray-50 to-slate-50">
          {error && (
            <div className="mb-6 p-4 bg-red-50 border-2 border-red-200 rounded-2xl flex items-start space-x-3 shadow-sm">
          ...
          <div className="mb-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
              ...
              <div className="px-5 py-4 bg-gradient-to-r from-indigo-50 to-purple-50 border-2 border-indigo-100 rounded-xl">
              ...
              <div>
                ...
                <div className="relative" ref={classDropdownRef}>
                  <button
                    ...
                    disabled={loading}
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-gray-200 rounded-lg text-left hover:border-gray-300 focus:outline-none focus:ring-2 transition-all flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{
              ...
              <div>
                ...
                <div className="relative" ref={examTypeDropdownRef}>
                  <button
                    ...
                    className="w-full px-3.5 py-2.5 bg-white border-2 border-gray-200 rounded-lg text-left hover:border-gray-300 focus:outline-none focus:ring-2 transition-all flex items-center justify-between"
                    style={{
                      ['--focus-ring-color' as any]: brand.colors.primary + '40'
                    }}
                  >
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-3.5 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all text-sm"
                    style={{
                      colorScheme: 'light'
                    }}
                  />
          ...
          <div className="mb-6">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
              {!startDate || !endDate ? (
                <div className="p-4 bg-gradient-to-r from-yellow-50 to-amber-50 border-2 border-yellow-200 rounded-lg text-xs text-yellow-800 flex items-center space-x-2">
                ...
                <>
                    ...
                    <div className="mb-6 p-5 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-200 rounded-xl">
                      ...
                      <div className="space-y-3">
                        {selectedRooms.map((room) => (
                          <div 
                            key={room.id}
                            className="flex items-center justify-between bg-white p-4 rounded-xl border-2 border-green-100 hover:border-green-200 transition-colors"
                          >
                            <div className="flex items-center space-x-3">
                  ...
                  {roomCapacityError && (
                    <div className="mb-4 p-4 bg-red-50 border-2 border-red-200 rounded-xl text-sm text-red-700 flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <div className="relative" ref={roomDropdownRef}>
                      <button
                        ...
                        className="w-full px-5 py-4 bg-white border-2 border-gray-200 rounded-xl text-left hover:border-gray-300 focus:outline-none focus:ring-2 transition-all flex items-center justify-between disabled:opacity-50 disabled:cursor-not-allowed"
                        style={{
                          ['--focus-ring-color' as any]: brand.colors.primary + '40'
                        }}
                      >
          ...
          {selectedClass && selectedRooms.length > 0 && students.length > 0 && (
            <div className="p-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 border-2 border-blue-200 rounded-2xl shadow-sm">
        ...
        {/* Footer with Actions */}
        <div className="px-6 py-4 border-t-2 border-gray-200 flex items-center justify-between bg-white">
          <p className="text-xs text-gray-500">
            <span className="text-red-500 font-semibold">*</span> Required fields • Rooms are booked automatically
          </p>
          <div className="flex items-center space-x-3">
            <button
              onClick={handleClose}
              disabled={loading}
              className="px-6 py-2 bg-white border-2 border-gray-300 hover:border-gray-400 hover:bg-gray-50 text-gray-700 font-semibold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              Cancel
            </button>
            <button
              ...
              className="px-8 py-2 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2 text-sm"
              style={{ background: brand.gradients.primary }}
            >
              {loading ? (
                <>
