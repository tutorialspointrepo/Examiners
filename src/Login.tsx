      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <div className="flex justify-center mb-6">
            <div 
              className="w-24 h-24 rounded-2xl flex items-center justify-center shadow-2xl relative overflow-hidden group"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="relative">
                  {/* Paper sheet */}
                  <div className="bg-white rounded-lg shadow-lg p-3 relative transform group-hover:scale-110 transition-transform duration-300">
                    {/* Document lines */}
                    <div className="space-y-1.5">
                      <div className="h-1 bg-gradient-to-r from-blue-400 to-purple-400 rounded-full w-8"></div>
                      <div className="h-1 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full w-6"></div>
                      <div className="h-1 bg-gradient-to-r from-pink-400 to-orange-400 rounded-full w-7"></div>
                    </div>
                    
                    {/* AI Checkmark overlay */}
                    <div className="absolute -top-2 -right-2 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full w-6 h-6 flex items-center justify-center shadow-lg animate-bounce">
                  ...
                  <div className="absolute -top-1 -left-1 w-2 h-2 bg-blue-400 rounded-full animate-pulse shadow-md"></div>
                  <div className="absolute -bottom-1 -right-1 w-2 h-2 bg-purple-400 rounded-full animate-pulse shadow-md" style={{animationDelay: '0.5s'}}></div>
                  <div className="absolute top-1/2 -right-2 w-1.5 h-1.5 bg-pink-400 rounded-full animate-pulse shadow-md" style={{animationDelay: '1s'}}></div>
                  
                  {/* Connection lines */}
                  <div className="absolute inset-0 pointer-events-none">
                    <div className="absolute top-0 left-0 w-3 h-0.5 bg-gradient-to-r from-blue-400/60 to-transparent rotate-45"></div>
                    <div className="absolute bottom-0 right-0 w-3 h-0.5 bg-gradient-to-l from-purple-400/60 to-transparent -rotate-45"></div>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center mb-8">
            <h1 className="font-bold text-gray-900 mb-2" style={{ fontSize: '1.5rem' }}>
              {brand.collegeName}
            </h1>
              ...
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2">
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${
                    ...
                    <FontAwesomeIcon icon={faEnvelope} className={errors.email ? 'text-red-600' : 'text-gray-600'} />
                  </div>
                </div>
                <input
                  id="email"
              ...
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2">
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${
                    ...
                    <FontAwesomeIcon icon={faLock} className={errors.password ? 'text-red-600' : 'text-gray-600'} />
                  </div>
                </div>
                <input
                  id="password"
