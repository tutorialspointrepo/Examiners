// reset_all_users_password.js
// Run: node reset_all_users_password.js
    ...
    do {
      ...
      for (const userRecord of listUsersResult.users) {
        ...
        try {
          ...
          successCount++;
          console.log(`✅ [${successCount}/${totalUsers}] Updated password for: ${userRecord.email || userRecord.uid}`);
          
        } catch (error) {
          errorCount++;
          const errorMsg = `❌ Failed for ${userRecord.email || userRecord.uid}: ${error.message}`;
